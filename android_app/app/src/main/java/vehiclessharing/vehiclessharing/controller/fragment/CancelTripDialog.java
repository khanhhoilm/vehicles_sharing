...
public class CancelTripDialog extends DialogFragment implements View.OnClickListener {
    ...
    private static CancelTrip.CancelTripInterface cancelTripInterface;
    ...
    public static CancelTripDialog newInstance(String apiToken, int vehType, CancelTrip.CancelTripInterface tripInterface) {
    ...
    private void cancelTrip() {
        ...
        CancelTrip.newInstance(cancelTripInterface).cancel(apiToken, vehicleType, comment);
